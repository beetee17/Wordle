...
struct BannerView: View {
    ...
    var body: some View {
        ...
        .background(
            ZStack {
                LinearGradient(gradient: Gradient(colors: [Color(#colorLiteral(red: 0.03205184274, green: 0.03314970656, blue: 0.04729758212, alpha: 1)).opacity(0.4), Color.accentColor.opacity(0.6)]), startPoint: .top, endPoint: .bottom)
            
                LinearGradient(gradient: Gradient(colors: [Color.accentColor.opacity(0.5), Color(#colorLiteral(red: 0.07820445112, green: 0.08963582299, blue: 0.09931479403, alpha: 1)).opacity(0.5)]), startPoint: .top, endPoint: .bottom)
